      ...
      <div className="flex min-h-screen w-full bg-muted/10">
        ...
        <Sidebar collapsible="icon" side="left">
          ...
          <SidebarContent>
            ...
            <SidebarGroup>
              <SidebarGroupLabel>Contenu & Ressources</SidebarGroupLabel>
              <SidebarGroupContent>
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={location.pathname.includes("/dashboard/modules")}>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={location.pathname.includes("/dashboard/lessons")}>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={location.pathname.includes("/dashboard/resources")}>
